...
**最終更新：2026-09-17（基礎データにアストロガール・ラクシャーガ・センリ・ベタピンを追加。キジン・ヘンガー・スエゾーのTSVを新設）**
...
5. 上の「現在の実数」の血統ページ数・技件数・sitemap URL数を`build.js`のログの値へ更新し、
...
- モンスター数・インデックス数・血統ページ数・技件数・sitemap URL数が変わる変更では、
